abclear "clear up everything so far...
...
abbreviate pydef def func(**kwargs):<CR>""" """<CR>
abbreviate pyclass class name:<CR>""" """<CR><CR>def __init__(self, **kwargs):<CR>"""Initializes objects of this type"""<CR>
