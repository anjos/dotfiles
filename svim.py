...
"""Starts neovim in a new iterm2 vertical split, honours all arguments

This command assumes you are starting a new neovim session from an existing tab
or window in iTerm2.
...
async def window_main(connection):
    ...
    split = await session.async_split_pane(
        vertical=True,
        before=True,
        profile="Neovim",
